...
The Employee Management module is the core of Syscend-HRM. It provides a centralised repository for all employee records, covering personal information, employment details, documents, and a full history of changes. Every other module — payroll, attendance, leave, performance — links back to this module.
