...
export default function EditComponent({ component }: Props) {
    ...
    function handleSubmit(e: React.FormEvent) {
        e.preventDefault();
        put(`/payroll/components/${component.id}`);
    }
                    ...
                    <CardContent className="p-6">
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="flex items-center justify-end gap-3 pt-2 border-t border-slate-200 dark:border-slate-700">
                                ...
                                >
                                    {processing ? 'Saving...' : 'Update Component'}
                                </Button>
                            </div>
                        </form>
                    </CardContent>
